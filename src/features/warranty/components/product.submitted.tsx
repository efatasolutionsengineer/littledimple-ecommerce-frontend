...
import { Product, ProductSubmittedProps } from '../types';


export const ProductSubmitted: React.FC<ProductSubmittedProps> = ({ products }) => {
    ...
    return (
        <div className="w-full overflow-x-auto mt-16">
            <h4 className='text-hijau-tua text-center text-3xl mb-8'>Product Submitted</h4>
