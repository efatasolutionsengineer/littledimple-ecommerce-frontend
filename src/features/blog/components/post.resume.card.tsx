            ...
            <div className="px-5 pt-2 pb-8 flex flex-col h-auto items-between justify-between grow">
                ...
                <div>
                    <div className="flex flex-row gap-2 items-center justify-between">
                        ...
                        <Link href={`/blog/${post.category}/${post.slug}`} className="text-sm text-neutral-gray font-medium text-primary font-(family-name:--font-dm-sans) flex flex-row items-center gap-2 rounded-full px-3 py-2 bg-neutral-white w-[130px] transition hover:bg-primary/20">Read More
